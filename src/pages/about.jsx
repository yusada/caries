      ...
      <section className="w-full flex justify-center relative z-10 py-20 mt-32">
        <div className="w-11/12 text-center">
          ...
          <p className="text-blue-400 mt-4 lg:w-2/3 w-full mx-auto">
            <span className="font-bold">Dental Caries</span>. Tooth decay, also
            known as dental caries, is a dental and oral health condition that
            can affect anyone. The symptoms include increased tooth sensitivity
            and pain when consuming sweet, cold, or hot foods.
          </p>
